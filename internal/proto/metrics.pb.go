...
func (Metric_MType) EnumDescriptor() ([]byte, []int) {
	return file_api_proto_metrics_proto_rawDescGZIP(), []int{0, 0}
}
...
const file_api_proto_metrics_proto_rawDesc = "" +
	"\n" +
	"\x17api/proto/metrics.proto\x12\ametrics\"\x90\x01\n" +
	"\x06Metric\x12\x0e\n" +
	...
	"\aMetrics\x12N\n" +
	"\rUpdateMetrics\x12\x1d.metrics.UpdateMetricsRequest\x1a\x1e.metrics.UpdateMetricsResponseB;Z9github.com/Pro100x3mal/go-musthave-metrics/internal/protob\x06proto3"
